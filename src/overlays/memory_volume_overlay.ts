import { Edge, NestedSDFG, SDFGElement } from '../renderer/renderer_elements';
...
export class MemoryVolumeOverlay extends GenericSdfgOverlay {
    ...
    public shade_edge(edge: Edge, ctx: any): void {
    ...
    public recursively_shade_sdfg(
        graph: DagreSDFG, ctx: any, ppp: number, visible_rect: any
    ): void {
