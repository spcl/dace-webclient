...
class CanvasManager {
    ...
    translate_element(el, old_mousepos, new_mousepos, entire_graph, sdfg_list,
        state_parent_list, drag_start, update_position_info = true, move_entire_edge = false, edge_dpoints = undefined) {
        this.stopAnimation();
...
class SDFGRenderer {
    constructor(sdfg, container, on_mouse_event = null, user_transform = null,
        ...
        if (this.overlay_manager !== null)
            this.overlay_manager.register_overlay(GenericSdfgOverlay.OVERLAY_TYPE.CONSTRUCTION);
    }
